...
plot_wbc  <- function_plot_hematologie(data = hematologie_df, column_name = "wbc", x_label = FALSE, title = "Mean white blood cell count (g/l)") +
  geom_point(outcome_KW_hematology %>% filter(outcome == "wbs"), mapping = aes(x = day, y = y_value), shape = 8, show.legend = FALSE, color = "black")

plot_plt  <- function_plot_hematologie(data = hematologie_df, column_name = "plt", x_label = FALSE, title = "Mean platelet count (g/l)") +
  geom_point(outcome_KW_hematology %>% filter(outcome == "plt"), mapping = aes(x = day, y = y_value), shape = 8, show.legend = FALSE, color = "black")

plot_neut <- function_plot_hematologie(data = hematologie_df, column_name = "neut", x_label = TRUE, title = "Mean neutrophil count (g/l)") +
  geom_point(outcome_KW_hematology %>% filter(outcome == "neut"), mapping = aes(x = day, y = y_value), shape = 8, show.legend = FALSE, color = "black")

plot_lymf <- function_plot_hematologie(data = hematologie_df, column_name = "lymf", x_label = TRUE, title = "Mean lymphocyte count (g/l)") +
  geom_point(outcome_KW_hematology %>% filter(outcome == "lymf"), mapping = aes(x = day, y = y_value), shape = 8, show.legend = FALSE, color = "black")
...
#------------------ Analyses
simple_KW_function <- function(data, day){
...
day_0_wbc  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 0)
day_3_wbc  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 3)
day_4_wbc  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 4)
day_6_wbc  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 6)
day_8_wbc  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 8)
day_10_wbc <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 10)
day_12_wbc <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 12)
day_14_wbc <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 14)
day_17_wbc <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 17)
day_21_wbc <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 21)
day_24_wbc <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 24)
day_28_wbc <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = wbc), day = 28)

day_0_plt  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 0)
day_3_plt  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 3)
day_4_plt  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 4)
day_6_plt  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 6)
day_8_plt  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 8)
day_10_plt <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 10)
day_12_plt <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 12)
day_14_plt <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 14)
day_17_plt <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 17)
day_21_plt <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 21)
day_24_plt <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 24)
day_28_plt <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = plt), day = 28)

day_0_lymf  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 0)
day_3_lymf  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 3)
day_4_lymf  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 4)
day_6_lymf  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 6)
day_8_lymf  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 8)
day_10_lymf <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 10)
day_12_lymf <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 12)
day_14_lymf <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 14)
day_17_lymf <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 17)
day_21_lymf <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 21)
day_24_lymf <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 24)
day_28_lymf <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = lymf), day = 28)

day_0_neut  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 0)
day_3_neut  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 3)
day_4_neut  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 4)
day_6_neut  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 6)
day_8_neut  <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 8)
day_10_neut <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 10)
day_12_neut <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 12)
day_14_neut <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 14)
day_17_neut <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 17)
day_21_neut <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 21)
day_24_neut <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 24)
day_28_neut <- simple_KW_function(data = hematologie_df %>% select(group, day, outcome = neut), day = 28)
